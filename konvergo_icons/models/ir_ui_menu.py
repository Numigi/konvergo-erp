...
ICONS = {
    ...
    "data_recycle.menu_data_cleaning_root": "data_cleaning.png",
    ...
    "mass_mailing_sms.mass_mailing_sms_menu_root": "sms_marketing.png",
    ...
    "spreadsheet_dashboard.spreadsheet_dashboard_menu_root": "dashboard.png",
